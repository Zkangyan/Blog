...
<title>Java个人博客系统后台管理页面-Powered by 黑幽灵</title>
...
/*后台页面的点击一个链接按钮显示在主页面上 并且判断是否存在 存在时就选择它 若不存在点击它显示出来#tabs 是ID     */
...
function openPasswordModifyDialog(){
	...
	/* 如果有很多就根据ID 修改  后面接一个ID 参数   ?Id  url只是一个定义*/
	url="admin/blogger/modifyPassword";
}
...
<body class="easyui-layout">
	...
	<!-- 中间的 -->
	<div region="center">
		<div class="easyui-tabs" fit="true" border="false" id="tabs"> <!--tabs  作为ID 当点击时获取其ID 然后显示  -->  
